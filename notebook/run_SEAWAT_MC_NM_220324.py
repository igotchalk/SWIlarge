...
hk = np.zeros_like(layer_mapping_ind,dtype=np.float)
...
hk[np.where(layer_mapping_ind==1)] = kh_lay1
hk[np.where(layer_mapping_ind==2)] = hk_aquitard
hk[np.where(layer_mapping_ind==3)] = lith_180[np.where(layer_mapping_ind==3)]
hk[np.where(layer_mapping_ind==4)] = hk_aquitard
hk[np.where(layer_mapping_ind==5)] = lith_400[np.where(layer_mapping_ind==5)]
hk[np.where(layer_mapping_ind>5)] = 1.
...
prsity = np.zeros_like(layer_mapping_ind,dtype=np.float)
prsity[np.isin(hk,(kh_lay1,kh_sand_180,kh_sand_400))]=por_sand
prsity[np.where(prsity==0.)]=por_clay
